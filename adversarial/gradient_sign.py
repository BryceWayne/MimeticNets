...
class FGSM(AttackBase) :
    def __init__(self, model=None, bound=None, norm=False, random_start=False, discrete=True, device=None, modelM=None, N=None, div=None, grad=None, **kwargs) :
        super(FGSM,self).__init__(model, norm, discrete, device)
        self.bound = bound
        self.rand = random_start

    @overrides
    def perturb(self, x, y, model=None, bound=None, device=None, modelM=None, N=None, div=None, grad=None, **kwargs) :
...
class LinfPGD(AttackBase) :
    def __init__(self, model=None, bound=None, step=None, iters=None, norm=False, random_start=False, discrete=True, device=None, modelM=None, N=None, div=None, grad=None,  **kwargs) :
    ...
    @overrides
    def perturb(self, x, y, model=None, bound=None, step=None, iters=None, device=None, modelM=None, N=None, div=None, grad=None, **kwargs) :
        criterion = self.criterion
        model = model or self.model
        bound = bound or self.bound
